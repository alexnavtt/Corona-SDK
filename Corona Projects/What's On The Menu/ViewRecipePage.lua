...
-- Info Bar
page_params.info_bar_height = 0.05*H

-- Title Banner
page_params.title_banner_height = 0.10*H
page_params.title_banner_bottom = page_params.title_banner_height + page_params.info_bar_height

-- Scroll Views
page_params.v_spacing = 0.02*H -- vertical spacing
page_params.h_spacing = 0.02*W -- horizontal spacing

page_params.scroll_view_top = page_params.title_banner_bottom + page_params.v_spacing/2
page_params.scroll_view_height = H - page_params.scroll_view_top - page_params.v_spacing/2

page_params.scroll_view_left_1 = page_params.h_spacing
page_params.scroll_view_width_1 = 0.45*W

page_params.scroll_view_left_2 = page_params.scroll_view_left_1 + page_params.scroll_view_width_1 + page_params.h_spacing
page_params.scroll_view_width_2 = W - page_params.scroll_view_width_1 - 3*page_params.h_spacing

-- Item Spacing
page_params.div_y  = 0.15*H
page_params.div_x1 = 0.30*W
page_params.div_x2 = page_params.div_x1 + 0.13*W

page_params.ingredient_level_delta = 0.1*H

page_params.step_level_delta = 0.015*H
